...
class RequestInquiryModel extends Equatable {
	final int? id;
	...
	factory RequestInquiryModel.fromJson(Map<String, dynamic> json) {
		return RequestInquiryModel(
			id: json['id'] as int?,
